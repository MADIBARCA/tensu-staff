...
const RU: Dict = {
  ...
  'students.filter.trainers': 'Тренеры',
  ...
  'students.details.trainer': 'Тренер',
  ...
  'management.employees.role.trainer': 'Тренер',
  ...
  'management.sections.trainers': 'Тренеры',
  'management.sections.trainer': 'Тренер',
  ...
  'management.sections.allTrainers': 'Все тренеры',
  ...
  'management.sections.noTrainers': 'Нет тренеров в этом клубе',
  ...
  'management.sections.errors.trainerRequired': 'Выберите хотя бы одного тренера',
...
const KK: Dict = {
  ...
  'students.filter.trainers': 'Жаттықтырушылар',
  ...
  'students.details.trainer': 'Жаттықтырушы',
  'students.details.tariff': 'Тариф',
  ...
  'profile.role.trainer': 'Жаттықтырушы',
  ...
  'management.employees.role.trainer': 'Жаттықтырушы',
  ...
  'management.sections.trainers': 'Жаттықтырушылар',
  'management.sections.trainer': 'Жаттықтырушы',
  'management.sections.groups': 'Топтар',
  'management.sections.moreGroups': 'тағы',
  'management.sections.club': 'Клуб',
  'management.sections.allClubs': 'Барлық клубтар',
  'management.sections.allTrainers': 'Барлық жаттықтырушылар',
  ...
  'management.sections.noTrainers': 'Бұл клубта жаттықтырушылар жоқ',
  ...
  'management.sections.errors.trainerRequired': 'Кем дегенде бір жаттықтырушы таңдаңыз',
