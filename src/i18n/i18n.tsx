...
const RU: Dict = {
  ...
  'students.extend.currentMembership': 'Текущий абонемент',
  'students.extend.currentTariff': 'Тариф',
  'students.extend.currentPrice': 'Цена',
  'students.extend.selectTariff': 'Выберите тариф',
  'students.extend.noTariffs': 'Нет доступных тарифов',
  'students.extend.current': 'Текущий',
  'students.extend.days': 'дней',
  'students.extend.newEnd': 'Новый срок окончания',
  'students.extend.totalPrice': 'К оплате',
  'students.extend.free': 'Бесплатно',
  'students.extend.customOptions': 'Дополнительные опции',
  'students.extend.useCustomPrice': 'Индивидуальная цена',
  'students.extend.customPrice': 'Цена для студента',
  'students.extend.paymentStatus': 'Статус оплаты',
  'students.extend.payment.paid': 'Оплачено',
  'students.extend.payment.pending': 'Ожидается',
  'students.extend.payment.free': 'Бесплатно',
  'students.extend.note': 'Заметка',
  'students.extend.notePlaceholder': 'Причина скидки, комментарий...',
  'students.extend.paymentType.monthly': 'Ежемесячный',
  'students.extend.paymentType.sessionPack': 'Пакет занятий',
  'students.extend.paymentType.semiAnnual': 'Полугодовой',
  'students.extend.paymentType.annual': 'Годовой',
  ...
  'students.individualPrice.title': 'Индивидуальная цена',
  'students.individualPrice.description': 'Установите индивидуальную цену абонемента для этого студента. Цена будет применяться при следующем продлении или покупке.',
  'students.individualPrice.selectTariff': 'Выберите тариф',
  'students.individualPrice.discountType': 'Тип скидки',
  'students.individualPrice.percentage': 'Процент',
  'students.individualPrice.fixedPrice': 'Фиксированная цена',
  'students.individualPrice.discountPercent': 'Размер скидки',
  'students.individualPrice.setPrice': 'Установить цену',
  'students.individualPrice.reason': 'Причина скидки',
  'students.individualPrice.reasons.female_discount': 'Скидка для девушек',
  'students.individualPrice.reasons.family_member': 'Член семьи',
  'students.individualPrice.reasons.student_discount': 'Студенческая скидка',
  'students.individualPrice.reasons.loyal_customer': 'Постоянный клиент',
  'students.individualPrice.reasons.group_discount': 'Групповая скидка',
  'students.individualPrice.reasons.promotional': 'Акция',
  'students.individualPrice.reasons.other': 'Другое',
  'students.individualPrice.customReasonPlaceholder': 'Укажите причину...',
  'students.individualPrice.setExpiry': 'Срок действия цены',
  'students.individualPrice.standardPrice': 'Стандартная цена',
  'students.individualPrice.individualPrice': 'Индивидуальная цена',
  'students.individualPrice.saving': 'Экономия',
  'students.individualPrice.save': 'Сохранить',
  'students.individualPrice.success': 'Индивидуальная цена установлена',
  'students.individualPrice.error': 'Ошибка при установке цены',

  // Students page tabs
  'students.tabs.students': 'Студенты',
  'students.tabs.priceRequests': 'Запросы цены',

  // Price Requests
  'priceRequests.title': 'Запросы на индивидуальную цену',
  'priceRequests.pendingCount': '{count} ожидают рассмотрения',
  'priceRequests.empty': 'Нет запросов',
  'priceRequests.emptyDescription': 'Когда студенты отправят запросы на индивидуальную цену, они появятся здесь',
  'priceRequests.filter.all': 'Все',
  'priceRequests.filter.pending': 'Ожидают',
  'priceRequests.filter.approved': 'Одобрены',
  'priceRequests.filter.declined': 'Отклонены',
  'priceRequests.status.pending': 'На рассмотрении',
  'priceRequests.status.approved': 'Одобрен',
  'priceRequests.status.declined': 'Отклонен',
  'priceRequests.standardPrice': 'Стандартная цена',
  'priceRequests.requested': 'Запрошено',
  'priceRequests.reason': 'Причина запроса',
  'priceRequests.message': 'Сообщение',
  'priceRequests.approvedAt': 'Одобрена цена: {price}',
  'priceRequests.responseMessage': 'Ответ',
  'priceRequests.setApprovedPrice': 'Установите цену для студента',
  'priceRequests.discountPercent': 'Скидка {percent}%',
  'priceRequests.responseToStudent': 'Сообщение для студента',
  'priceRequests.responsePlaceholder': 'Необязательно...',
  'priceRequests.approve': 'Одобрить',
  'priceRequests.decline': 'Отклонить',
  'priceRequests.confirmApprove': 'Подтвердить',
  'priceRequests.approveSuccess': 'Запрос одобрен. Индивидуальная цена установлена.',
  'priceRequests.declineSuccess': 'Запрос отклонён',
  'priceRequests.error': 'Произошла ошибка. Попробуйте ещё раз.',
  ...
  'profile.createClub.errors.createError': 'Не удалось создать клуб',
  'profile.createClub.errors.clubAlreadyExists': 'Клуб с таким названием уже существует',
  'profile.createClub.errors.limitReached': 'Достигнут лимит количества клубов',
  ...
  'management.employees.errors.staffAlreadyExists': 'Сотрудник уже добавлен в этот клуб',
  'management.employees.errors.invitationAlreadySent': 'Приглашение уже отправлено этому сотруднику',
  'management.employees.errors.noPermission': 'У вас нет прав для добавления сотрудников',
...
const KK: Dict = {
  ...
  'students.action.setPrice': 'Баға',
  'students.extend.title': 'Абонементті ұзарту',
  'students.extend.studentName': 'Студент',
  'students.extend.currentEnd': 'Ағымдағы аяқталу мерзімі',
  'students.extend.currentMembership': 'Ағымдағы абонемент',
  'students.extend.currentTariff': 'Тариф',
  'students.extend.currentPrice': 'Бағасы',
  'students.extend.selectTariff': 'Тарифті таңдаңыз',
  'students.extend.noTariffs': 'Қол жетімді тарифтер жоқ',
  'students.extend.current': 'Ағымдағы',
  'students.extend.days': 'күн',
  'students.extend.newEnd': 'Жаңа аяқталу мерзімі',
  'students.extend.totalPrice': 'Төлемге',
  'students.extend.free': 'Тегін',
  'students.extend.customOptions': 'Қосымша опциялар',
  'students.extend.useCustomPrice': 'Жеке баға',
  'students.extend.customPrice': 'Студент үшін баға',
  'students.extend.paymentStatus': 'Төлем күйі',
  'students.extend.payment.paid': 'Төленді',
  'students.extend.payment.pending': 'Күтілуде',
  'students.extend.payment.free': 'Тегін',
  'students.extend.note': 'Ескерту',
  'students.extend.notePlaceholder': 'Жеңілдік себебі, түсініктеме...',
  'students.extend.paymentType.monthly': 'Айлық',
  'students.extend.paymentType.sessionPack': 'Сабақ пакеті',
  'students.extend.paymentType.semiAnnual': 'Жарты жылдық',
  'students.extend.paymentType.annual': 'Жылдық',
  ...
  // Individual Price Modal
  'students.individualPrice.title': 'Жеке баға',
  'students.individualPrice.description': 'Бұл студент үшін абонементтің жеке бағасын белгілеңіз. Баға келесі ұзарту немесе сатып алу кезінде қолданылады.',
  'students.individualPrice.selectTariff': 'Тарифті таңдаңыз',
  'students.individualPrice.discountType': 'Жеңілдік түрі',
  'students.individualPrice.percentage': 'Пайыз',
  'students.individualPrice.fixedPrice': 'Бекітілген баға',
  'students.individualPrice.discountPercent': 'Жеңілдік мөлшері',
  'students.individualPrice.setPrice': 'Баға белгілеу',
  'students.individualPrice.reason': 'Жеңілдік себебі',
  'students.individualPrice.reasons.female_discount': 'Қыздарға жеңілдік',
  'students.individualPrice.reasons.family_member': 'Отбасы мүшесі',
  'students.individualPrice.reasons.student_discount': 'Студенттік жеңілдік',
  'students.individualPrice.reasons.loyal_customer': 'Тұрақты клиент',
  'students.individualPrice.reasons.group_discount': 'Топтық жеңілдік',
  'students.individualPrice.reasons.promotional': 'Акция',
  'students.individualPrice.reasons.other': 'Басқа',
  'students.individualPrice.customReasonPlaceholder': 'Себебін көрсетіңіз...',
  'students.individualPrice.setExpiry': 'Бағаның жарамдылық мерзімі',
  'students.individualPrice.standardPrice': 'Стандартты баға',
  'students.individualPrice.individualPrice': 'Жеке баға',
  'students.individualPrice.saving': 'Үнемдеу',
  'students.individualPrice.save': 'Сақтау',
  'students.individualPrice.success': 'Жеке баға белгіленді',
  'students.individualPrice.error': 'Баға белгілеу қатесі',

  // Students page tabs
  'students.tabs.students': 'Студенттер',
  'students.tabs.priceRequests': 'Баға сұраулары',

  // Price Requests
  'priceRequests.title': 'Жеке бағаға сұраулар',
  'priceRequests.pendingCount': '{count} қарауды күтуде',
  'priceRequests.empty': 'Сұраулар жоқ',
  'priceRequests.emptyDescription': 'Студенттер жеке бағаға сұрау жібергенде, олар осында көрінеді',
  'priceRequests.filter.all': 'Барлығы',
  'priceRequests.filter.pending': 'Күтуде',
  'priceRequests.filter.approved': 'Мақұлданды',
  'priceRequests.filter.declined': 'Қабылданбады',
  'priceRequests.status.pending': 'Қарастырылуда',
  'priceRequests.status.approved': 'Мақұлданды',
  'priceRequests.status.declined': 'Қабылданбады',
  'priceRequests.standardPrice': 'Стандартты баға',
  'priceRequests.requested': 'Сұралған',
  'priceRequests.reason': 'Сұрау себебі',
  'priceRequests.message': 'Хабарлама',
  'priceRequests.approvedAt': 'Мақұлданған баға: {price}',
  'priceRequests.responseMessage': 'Жауап',
  'priceRequests.setApprovedPrice': 'Студент үшін баға белгілеңіз',
  'priceRequests.discountPercent': 'Жеңілдік {percent}%',
  'priceRequests.responseToStudent': 'Студентке хабарлама',
  'priceRequests.responsePlaceholder': 'Міндетті емес...',
  'priceRequests.approve': 'Мақұлдау',
  'priceRequests.decline': 'Қабылдамау',
  'priceRequests.confirmApprove': 'Растау',
  'priceRequests.approveSuccess': 'Сұрау мақұлданды. Жеке баға белгіленді.',
  'priceRequests.declineSuccess': 'Сұрау қабылданбады',
  'priceRequests.error': 'Қате пайда болды. Қайтадан көріңіз.',
  ...
  'profile.createClub.errors.createError': 'Клубты құру мүмкін болмады',
  'profile.createClub.errors.clubAlreadyExists': 'Бұл атаумен клуб бұрыннан бар',
  'profile.createClub.errors.limitReached': 'Клубтар санының лимитіне жеттіңіз',
  ...
  'management.employees.errors.staffAlreadyExists': 'Қызметкер бұл клубқа қосылған',
  'management.employees.errors.invitationAlreadySent': 'Шақыру бұл қызметкерге жіберілген',
  'management.employees.errors.noPermission': 'Сізде қызметкерлерді қосу құқығы жоқ',
...
const EN: Dict = {
  ...
  'profile.createClub.errors.createError': 'Failed to create club',
  'profile.createClub.errors.clubAlreadyExists': 'A club with this name already exists',
  'profile.createClub.errors.limitReached': 'Club limit reached',
  ...
  'students.action.extend': 'Extend',
  'students.action.freeze': 'Freeze',
  'students.action.markAttendance': 'Mark',
  'students.action.setPrice': 'Price',
  'students.extend.title': 'Extend Membership',
  'students.extend.studentName': 'Student',
  'students.extend.currentEnd': 'Current end date',
  'students.extend.currentMembership': 'Current Membership',
  'students.extend.currentTariff': 'Tariff',
  'students.extend.currentPrice': 'Price',
  'students.extend.selectTariff': 'Select tariff',
  'students.extend.noTariffs': 'No available tariffs',
  'students.extend.current': 'Current',
  'students.extend.days': 'days',
  'students.extend.newEnd': 'New end date',
  'students.extend.totalPrice': 'Total',
  'students.extend.free': 'Free',
  'students.extend.customOptions': 'Additional Options',
  'students.extend.useCustomPrice': 'Custom price',
  'students.extend.customPrice': 'Price for student',
  'students.extend.paymentStatus': 'Payment status',
  'students.extend.payment.paid': 'Paid',
  'students.extend.payment.pending': 'Pending',
  'students.extend.payment.free': 'Free',
  'students.extend.note': 'Note',
  'students.extend.notePlaceholder': 'Discount reason, comment...',
  'students.extend.paymentType.monthly': 'Monthly',
  'students.extend.paymentType.sessionPack': 'Session Pack',
  'students.extend.paymentType.semiAnnual': 'Semi-annual',
  'students.extend.paymentType.annual': 'Annual',
  'students.extend.confirm': 'Extend',
  'students.extend.success': 'Membership extended',
  'students.extend.error': 'Failed to extend membership',
  
  // Individual Price Modal
  'students.individualPrice.title': 'Individual Price',
  'students.individualPrice.description': 'Set an individual membership price for this student. The price will be applied on next renewal or purchase.',
  'students.individualPrice.selectTariff': 'Select tariff',
  'students.individualPrice.discountType': 'Discount type',
  'students.individualPrice.percentage': 'Percentage',
  'students.individualPrice.fixedPrice': 'Fixed price',
  'students.individualPrice.discountPercent': 'Discount amount',
  'students.individualPrice.setPrice': 'Set price',
  'students.individualPrice.reason': 'Discount reason',
  'students.individualPrice.reasons.female_discount': 'Female discount',
  'students.individualPrice.reasons.family_member': 'Family member',
  'students.individualPrice.reasons.student_discount': 'Student discount',
  'students.individualPrice.reasons.loyal_customer': 'Loyal customer',
  'students.individualPrice.reasons.group_discount': 'Group discount',
  'students.individualPrice.reasons.promotional': 'Promotional',
  'students.individualPrice.reasons.other': 'Other',
  'students.individualPrice.customReasonPlaceholder': 'Specify reason...',
  'students.individualPrice.setExpiry': 'Price expiry date',
  'students.individualPrice.standardPrice': 'Standard price',
  'students.individualPrice.individualPrice': 'Individual price',
  'students.individualPrice.saving': 'Saving',
  'students.individualPrice.save': 'Save',
  'students.individualPrice.success': 'Individual price set',
  'students.individualPrice.error': 'Failed to set price',

  // Students page tabs
  'students.tabs.students': 'Students',
  'students.tabs.priceRequests': 'Price Requests',

  // Price Requests
  'priceRequests.title': 'Individual Price Requests',
  'priceRequests.pendingCount': '{count} pending review',
  'priceRequests.empty': 'No requests',
  'priceRequests.emptyDescription': 'When students request individual pricing, they will appear here',
  'priceRequests.filter.all': 'All',
  'priceRequests.filter.pending': 'Pending',
  'priceRequests.filter.approved': 'Approved',
  'priceRequests.filter.declined': 'Declined',
  'priceRequests.status.pending': 'Pending Review',
  'priceRequests.status.approved': 'Approved',
  'priceRequests.status.declined': 'Declined',
  'priceRequests.standardPrice': 'Standard price',
  'priceRequests.requested': 'Requested',
  'priceRequests.reason': 'Request reason',
  'priceRequests.message': 'Message',
  'priceRequests.approvedAt': 'Approved price: {price}',
  'priceRequests.responseMessage': 'Response',
  'priceRequests.setApprovedPrice': 'Set price for student',
  'priceRequests.discountPercent': '{percent}% discount',
  'priceRequests.responseToStudent': 'Message to student',
  'priceRequests.responsePlaceholder': 'Optional...',
  'priceRequests.approve': 'Approve',
  'priceRequests.decline': 'Decline',
  'priceRequests.confirmApprove': 'Confirm',
  'priceRequests.approveSuccess': 'Request approved. Individual price set.',
  'priceRequests.declineSuccess': 'Request declined',
  'priceRequests.error': 'An error occurred. Please try again.',
  ...
  'management.employees.errors.staffAlreadyExists': 'Staff member is already added to this club',
  'management.employees.errors.invitationAlreadySent': 'Invitation has already been sent to this staff member',
  'management.employees.errors.noPermission': 'You do not have permission to add staff',
  ...
  'privacy.contact.text': 'Questions and requests about personal data: Telegram @tensuadmin',
