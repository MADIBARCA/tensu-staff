...
const RU: Dict = {
  ...
  'onboarding.guest': 'Гость',
  'onboarding.welcomeTitle': 'Добро пожаловать, {name}!',
  'onboarding.welcomeSubtitle': 'Приложение для управления вашим клубом',
  'onboarding.feature1Title': 'Управление расписанием',
  'onboarding.feature1Desc': 'Создавайте и редактируйте тренировки',
  'onboarding.feature2Title': 'Работа с клиентами',
  'onboarding.feature2Desc': 'Отслеживайте посещаемость и абонементы',
  'onboarding.feature3Title': 'Управление клубом',
  'onboarding.feature3Desc': 'Добавляйте секции и сотрудников',
  'onboarding.phonePermissionNotice': 'Для регистрации нам необходим доступ к вашему номеру телефона из Telegram',
  'onboarding.sharePhone': 'Поделиться номером',
  'onboarding.processing': 'Обработка...',
  'onboarding.processingDesc': 'Регистрируем ваш аккаунт',
  'onboarding.successTitle': 'Готово!',
  'onboarding.successDesc': 'Ваш профиль успешно создан',
  'onboarding.redirecting': 'Переходим в приложение...',
  'onboarding.errorTitle': 'Ошибка',
  'onboarding.errorDesc': 'Не удалось создать профиль',
  'onboarding.createError': 'Ошибка создания профиля',
  'onboarding.telegramError': 'Ошибка Telegram',
  'onboarding.tryAgain': 'Попробовать снова',
  'onboarding.noAccessTitle': 'Нет доступа',
  'onboarding.noAccessDesc': 'Вы не приглашены ни в один клуб как сотрудник',
  'onboarding.noAccessHint': 'Попросите владельца клуба добавить вас как тренера или администратора',
  'onboarding.phoneTitle': 'Поделитесь номером',
  'onboarding.phoneDesc': 'Нажмите кнопку для получения номера из Telegram',
  'onboarding.phoneAccessDenied': 'Доступ к номеру отклонён',
...
const KK: Dict = {
  ...
  // Onboarding
  'onboarding.loading': 'Деректеріңізді жүктеуде...',
  'onboarding.guest': 'Қонақ',
  'onboarding.welcomeTitle': 'Қош келдіңіз, {name}!',
  'onboarding.welcomeSubtitle': 'Клубты басқаруға арналған қосымша',
  'onboarding.feature1Title': 'Кесте басқару',
  'onboarding.feature1Desc': 'Жаттығуларды жасау және өңдеу',
  'onboarding.feature2Title': 'Клиенттермен жұмыс',
  'onboarding.feature2Desc': 'Қатысу мен абонементтерді бақылау',
  'onboarding.feature3Title': 'Клубты басқару',
  'onboarding.feature3Desc': 'Бөлімдер мен қызметкерлерді қосу',
  'onboarding.phonePermissionNotice': 'Тіркелу үшін Telegram-дағы телефон нөміріңізге рұқсат қажет',
  'onboarding.sharePhone': 'Нөмірді бөлісу',
  'onboarding.processing': 'Өңдеу...',
  'onboarding.processingDesc': 'Аккаунтыңызды тіркеуде',
  'onboarding.successTitle': 'Дайын!',
  'onboarding.successDesc': 'Профиліңіз сәтті жасалды',
  'onboarding.redirecting': 'Қосымшаға өтуде...',
  'onboarding.errorTitle': 'Қате',
  'onboarding.errorDesc': 'Профиль жасау мүмкін болмады',
  'onboarding.createError': 'Профиль жасау қатесі',
  'onboarding.telegramError': 'Telegram қатесі',
  'onboarding.tryAgain': 'Қайта көру',
  'onboarding.noAccessTitle': 'Рұқсат жоқ',
  'onboarding.noAccessDesc': 'Сіз ешбір клубқа қызметкер ретінде шақырылмағансыз',
  'onboarding.noAccessHint': 'Клуб иесінен сізді жаттықтырушы немесе әкімші ретінде қосуын сұраңыз',
  'onboarding.phoneTitle': 'Нөмірді бөлісіңіз',
  'onboarding.phoneDesc': 'Telegram-дан нөмір алу үшін батырманы басыңыз',
  'onboarding.phoneAccessDenied': 'Нөмірге рұқсат берілмеді',
  'onboarding.skipForNow': 'Өткізіп жіберу',
...
const EN: Dict = {
  ...
  'onboarding.welcomeSubtitle': 'App for managing your club',
  'onboarding.feature1Title': 'Schedule Management',
  'onboarding.feature1Desc': 'Create and edit trainings',
  'onboarding.feature2Title': 'Client Management',
  'onboarding.feature2Desc': 'Track attendance and memberships',
  'onboarding.feature3Title': 'Club Management',
  'onboarding.feature3Desc': 'Add sections and staff',
  'onboarding.phonePermissionNotice': 'To register, we need access to your phone number from Telegram',
  'onboarding.sharePhone': 'Share Phone Number',
  'onboarding.processing': 'Processing...',
  'onboarding.processingDesc': 'Registering your account',
  'onboarding.successTitle': 'Done!',
  'onboarding.successDesc': 'Your profile has been created',
  'onboarding.redirecting': 'Redirecting to app...',
  'onboarding.errorTitle': 'Error',
  'onboarding.errorDesc': 'Failed to create profile',
  'onboarding.createError': 'Profile creation error',
  'onboarding.telegramError': 'Telegram error',
  'onboarding.tryAgain': 'Try Again',
  'onboarding.noAccessTitle': 'No Access',
  'onboarding.noAccessDesc': 'You have not been invited to any club as staff',
  'onboarding.noAccessHint': 'Ask the club owner to add you as a coach or admin',
  'onboarding.phoneTitle': 'Share Your Number',
  'onboarding.phoneDesc': 'Click the button to get the number from Telegram',
  'onboarding.phoneAccessDenied': 'Phone access denied',
  'onboarding.skipForNow': 'Skip for now',
  'onboarding.privacyNotice': 'By clicking the button, you agree to our privacy policy',
